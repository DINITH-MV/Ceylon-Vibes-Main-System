  ...
  return (
    <div className="bg-[#c7aa6d]">
      ...
      <div className="flex justify-center mt-8">
        ...
        <Link to="/bus1">
          <button className="bg-[#7b4949] font-Barlow mr-4 mt-4 rounded-md h-10 w-24 text-black text-lg">
            Bus
          </button>
        </Link>
      </div>
      <div>
        <div className="flex flex-wrap justify-center bg-[#c7aa6d]">
          {loading ? (
            ...
            <p className="my-36">No Buses found</p>
          ) : (
            cars.map((x, index) => (
              <div
                key={index}
              ...
              >
                ...
                />
                {x.maxPersons && (
                  <p className="text-sm">Capacity: {x.maxPersons}</p> // Render capacity if it exists
                )}
