    ...
    <div style={{ backgroundImage: 'linear-gradient(to bottom,#f6e5e4,#259f6c' }}>
      ...
      <div>
        ...
        <div className="flex w-full justify-evenly">
          ...
          <Link to="/art3">
            <button className="bg-[#7e4b4b] font-Barlow mr-4 mt-4 rounded-md h-10 w-60 text-black text-xl">
              Cultural Experience
            </button>
          </Link>

          <Link to="/art4">
            <button className="bg-[#879d62] font-Barlow mr-4 mt-4 rounded-md h-10 w-[260px] text-black text-xl">
              Historical Sites
            </button>
          </Link>
        </div>
      ...
      <CulExp searchQuery={searchQuery} />
      <br></br>
      <br></br>
      <Footer />
    </div>
