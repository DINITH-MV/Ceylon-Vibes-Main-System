    ...
    <div className="bg-[#f0f0f0] h-[100%] mt-[-20px]">
      ...
      <div className="flex pt-[40px] ml-[20px]">
        ...
        <div className="w-[310px] h-[1400px] mr-[10px] border border-[#d3d3d3] rounded-[14px] bg-[#ffffff]">
          <div className="mt-[30px] ml-[55px] font-Spirax absolute text-[24pt] px-[10px] border border-[#8c8c8c] rounded-[11px] py-[8px]">CeylonVibes</div>
          <div className="border border-[#969696] py-[6px] pb-[15px] mt-[110px] mx-[20px] rounded-[11px]">
        ...
        <div className="w-[1120px] ml-[20px]">
          ...
          <div variant="gradient" color="gray" className="rounded-[12px] mt-[20px] absolute ml-[26px] z-10 bg-[#000] w-[1060px] mb-8 p-6">
                            <div variant="h6" color="white" className="text-white text-[14pt] font-bold">                                
                                MANAGE ACCOUNT INFO 
                            </div>
                        </div>
          <div className="mt-[60px] border border-[#d3d3d3] bg-[#ffffff] rounded-[7px] pl-[70px] pt-[80px] h-[1470px]">
