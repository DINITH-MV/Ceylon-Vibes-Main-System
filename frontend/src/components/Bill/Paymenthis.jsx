  ...
  const handleSort = (type) => {
    ...
    switch (type) {
      ...
      case 'lastToFirst':
        ...
        break;
      case 'highestValue':
        sortedPayments.sort((a, b) => b.Value - a.Value);
        break;
      default:
        sortedPayments.sort((a, b) => new Date(a.date) - new Date(b.date));
    }
          ...
          <table className="table-auto w-full border-collapse border border-gray-200">
            <thead>
              <tr>
                ...
                <th className="px-6 py-3 bg-[#808080] text-left text-xs font-5xl text-white uppercase tracking-wider">Amount</th>
                <th className="px-6 py-3 bg-[#808080] text-left text-xs font-5xl text-white uppercase tracking-wider">Payment Method</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-200">
              {filteredPayments.slice(startIndex, endIndex).map((payment, index) => (
